...
const createBooks = (data) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(Object.assign(Object.assign({}, data), { publicationDate: new Date(data.publicationDate) }));
    const result = yield prisma_1.default.book.create({
        data: Object.assign(Object.assign({}, data), { publicationDate: new Date(data.publicationDate) }),
    });
    return result;
});
...
const getBooksByCategory = (catId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.book.findMany({
        where: {
            categoryId: catId,
        },
